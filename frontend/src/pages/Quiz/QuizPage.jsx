...
export const QuizPage = () => {
  ...
  return (
    <>
      <div
        className={"min-h-screen relative overflow-hidden custom-background bg-cover"}
      // className="relative w-full h-screen bg-full bg-center overflow-hidden animate-bg-transition-continuous"
      >
        {selectedGenre === 0 ? (
          <div>
